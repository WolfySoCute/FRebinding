    ...
    public static void register() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (autoPause.wasPressed()) {
                ...
                if (client.options.pauseOnLostFocus) client.player.sendMessage(Text.translatable("autoPause.enabled"), false);
                else client.player.sendMessage(Text.translatable("autoPause.disabled"), false);
            }
        });
    }
}
